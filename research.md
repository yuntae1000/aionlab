...
<div style="display:flex; gap:24px; align-items:flex-start; flex-wrap:wrap; margin:32px 0;">
  ...
  <div style="flex:1; min-width:280px; text-align:center;">
    <div style="display:inline-block; padding:10px 18px; background:transparent;">
      <img src="{{ '/assets/images/neural1.png' | relative_url }}"
           alt="Neural Interface System IC"
           style="width:85%; max-width:380px; height:auto; display:inline-block; vertical-align:middle;">
    </div>
  </div>
  ...
  <div style="flex:1; min-width:280px; text-align:center;">
    <div style="display:inline-block; padding:10px 18px; background:transparent;">
      <img src="{{ '/assets/images/physical1.png' | relative_url }}"
           ...
           style="width:95%; max-width:400px; height:auto; display:inline-block; vertical-align:middle;">
    </div>
  </div>
  ...
  <div style="flex:1; min-width:280px; text-align:center;">
    <div style="display:inline-block; padding:10px 18px; background:transparent;">
      <img src="{{ '/assets/images/pim1.png' | relative_url }}"
           ...
           style="width:75%; max-width:320px; height:auto; display:inline-block; vertical-align:middle;">
    </div>
  </div>
